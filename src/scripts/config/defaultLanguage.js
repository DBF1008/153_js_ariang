(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'Failed to apply import settings!': 'Failed to apply import settings!',
            'Back': 'Back',
            'Global Settings': 'Global Settings',
            'Default RPC Connection': 'Default RPC Connection',
            'Extended RPC Servers': 'Extended RPC Servers',
            'No changes detected': 'No changes detected',
            '{count} field(s) changed': '{{count}} field(s) changed',
            'Setting Name': 'Setting Name',
            'Current Value': 'Current Value',
            'Imported Value': 'Imported Value',
            'Duplicate': 'Duplicate',
            'Will override existing': 'Will override existing',
            'No extended RPC servers in imported config': 'No extended RPC servers in imported config',
