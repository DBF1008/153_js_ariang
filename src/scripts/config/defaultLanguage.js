(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'Import RPC connections': 'Import RPC connections',
            'Merge (keep current connections and default)': 'Merge (keep current connections and default)',
            'Replace (overwrite all current settings)': 'Replace (overwrite all current settings)',
            'No global settings found in the imported data.': 'No global settings found in the imported data.',
            'No RPC connections found in the imported data.': 'No RPC connections found in the imported data.',
            'The current default RPC connection will be kept:': 'The current default RPC connection will be kept:',
            '{total} setting(s), {changed} changed': '{total} setting(s), {changed} changed',
            'Duplicate': 'Duplicate',
            'Are you sure you want to import the selected settings?': 'Are you sure you want to import the selected settings?',
